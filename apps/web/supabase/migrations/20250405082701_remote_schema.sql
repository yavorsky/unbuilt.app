...
create type "public"."analytics_type" as enum ('unknown', 'amplitude', 'fathom', 'googleAnalytics', 'matomo', 'mixpanel', 'plausible', 'umami', 'vercelAnalytics', 'clarity', 'hotjar', 'posthog', 'splitbee', 'countly');
