...
const TrackJS = ({ width = 24, height, className = '' }: LogoProps) => {
  const calculatedHeight = height || width * (65 / 70); // Approximate aspect ratio
