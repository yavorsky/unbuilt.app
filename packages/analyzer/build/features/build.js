...
export class BuildFeaturesDetector {
    ...
    detect() {
        return __awaiter(this, void 0, void 0, function* () {
            return {
                bundler: yield this.detectBundler(),
                transpiler: yield this.detectTranspiler(),
                minifier: yield this.detectMinifier(),
                optimization: yield this.detectOptimizations(),
            };
        });
    }
    detectBundler() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const globalMarkers = yield this.page.evaluate(() => {
                ...
                return {
                    ...
                    viteMarkers: [
                        ...
                        '__vite__base',
                        '__vite__import',
                    ].some(marker => window[marker] !== undefined),
                    // Webpack markers
                    webpackMarkers: [
                        'webpackChunk',
                        'webpackJsonp',
            ...
            if (globalMarkers.webpackMarkers)
                scores.webpack += 0.4;
            if (globalMarkers.rollupMarkers)
                scores.rollup += 0.4;
            if (globalMarkers.viteMarkers || globalMarkers.viteEnvVars.length > 0)
                scores.vite += 0.4;
            if (globalMarkers.parcelMarkers)
                scores.parcel += 0.4;
            // Helper function to check patterns
            const checkPatterns = (content, bundler, category, weight) => {
                const bundlerPatternsList = patterns[bundler][category];
                bundlerPatternsList.forEach((pattern) => {
    ...
    detectTranspiler() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const calculateScore = (content, transpilerPatterns) => {
                const weights = {
            ...
            // Detect features
            const detectedFeatures = Object.entries(featurePatterns).reduce((acc, [feature, patterns]) => (Object.assign(Object.assign({}, acc), { [feature]: patterns.some(pattern => pattern.test(allScripts)) })), {});
            return {
                name: mainTranspiler,
    ...
    detectMinifier() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const calculateMatches = (content, patternSet) => {
                let matches = 0;
            ...
            const metrics = {
                ...
                hasSourceMap: Array.from(this.resources.getAll())
                    .some(r => { var _a; return (_a = r.url) === null || _a === void 0 ? void 0 : _a.endsWith('.map'); }),
    ...
    detectOptimizations() {
        return __awaiter(this, void 0, void 0, function* () {
            const hasCodeSplitting = Array.from(this.resources.getAll())
                ...
                .some((r) => { var _a; return (_a = r.url) === null || _a === void 0 ? void 0 : _a.includes('chunk'); });
            const hasTreeShaking = Array.from(this.resources.getAllScripts()).some((script) => script.includes('/*#__PURE__*/') || script.includes('/*@__PURE__*/'));
            const hasDynamicImports = Array.from(this.resources.getAllScripts()).some((script) => script.includes('import(') || script.includes('require.ensure'));
            return {
